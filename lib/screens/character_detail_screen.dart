...
class CharacterDetailScreen extends StatelessWidget {
      ...
      builder: (context, provider, child) {
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                _buildImage(context, character),
                _buildDetailsContainer(context, character),
              ],
            ),
          ),
        );
  ...
  Widget _buildImage(BuildContext context, Character character) {
  ...
  Widget _buildDetailsContainer(BuildContext context, Character character) {
    return Container(
      width: double.infinity,
